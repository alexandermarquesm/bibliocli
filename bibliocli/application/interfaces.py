...
class BookTextFormatter(ABC):
    ...
    """
    @abstractmethod
    def format_text(self, raw_text: Union[str, bytes], source: str, title: str = None, author: str = None) -> str:
...
class IBookRepository(ABC):
    """
    Interface/Contrato (Port) para Repositórios de armazenamento.
    """
    @abstractmethod
    ...
    @abstractmethod
    async def save(self, book: FormattedBook) -> str:
        pass
