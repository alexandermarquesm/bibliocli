...
from bibliocli.application.use_cases import DownloadBookUseCase
...
from bibliocli.infrastructure.cli.cli_formatter import CLIFormatter
...
def run_cli():
    ...
    if args.command == "search":
        ...
        from bibliocli.application.interfaces import BookDownloadProvider, RestrictedBookError
