...
# Popular Books Integration Plan Plan

> Create use cases for popular books in BiblioCLI and integrate with Flow-Read frontend.
...
- **Total symbols discovered:** 40
- **Architecture layers:** Utils, Controllers, Models, Services
- **Detected patterns:** Repository, Controller
- **Entry points:** src/infrastructure/web/static/js/main.js

### Key Components
**Core Classes:**
- `TestModularBookParsing` — /home/gangplank/projects/bibliocli/tests/test_openai_formatter.py:8
- `BookAnalyzer` — /home/gangplank/projects/bibliocli/tests/book_analyzer.py:7
- `BookSource` — /home/gangplank/projects/bibliocli/src/domain/value_objects.py:5
- `BookLink` — /home/gangplank/projects/bibliocli/src/domain/value_objects.py:21
- `BookSearchResult` — /home/gangplank/projects/bibliocli/src/domain/entities.py:6
## Agent Lineup
